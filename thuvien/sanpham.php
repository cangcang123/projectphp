      ...
      <div class="prod_box_big">
        ...
        <div class="center_prod_box_big">
          ...
          <div class="details_big_box">
            ...
            <div class="specifications">Loại: <span class="blue"><?php echo $value["type"] ?></span><br />
              Dung lượng: <span class="blue"><?php echo $value["gb"] ?> GB</span><br />
              Màu :<span class="blue"> <?php echo $value["color"] ?></span><br />
              thông tin :<span class="blue"> <?php echo $value["content"] ?>. </span><br />
            </div>
            <div class="prod_price_big"><span class="reduce"></span> <span class="price"><?php echo number_format($value["price"],0,',','.') ?> VNĐ</span></div>
